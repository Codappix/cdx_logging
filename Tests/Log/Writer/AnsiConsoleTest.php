    ...
    public function possibleLogRecords()
    {
        return [
            'Debug log' => [
                LogLevel::DEBUG,
                'The message to log',
                AnsiConsole::FG_BLUE . 'The message to log' . AnsiConsole::END,
            ],
            'Info log' => [
                LogLevel::INFO,
                'The message to log',
                AnsiConsole::FG_GREEN . 'The message to log' . AnsiConsole::END,
            ],
            'Notice log' => [
                LogLevel::NOTICE,
                'The message to log',
                AnsiConsole::FG_WHITE . 'The message to log' . AnsiConsole::END,
            ],
            'Warning log' => [
                LogLevel::WARNING,
                'The message to log',
                AnsiConsole::FG_YELLOW . 'The message to log' . AnsiConsole::END,
            ],
            'Error log' => [
                LogLevel::ERROR,
                'The message to log',
                AnsiConsole::FG_RED . 'The message to log' . AnsiConsole::END,
            ],
            'Critical log' => [
                LogLevel::CRITICAL,
                'The message to log',
                AnsiConsole::FG_BLACK . AnsiConsole::BG_CYAN . 'The message to log' . AnsiConsole::END,
            ],
            'Alert log' => [
                LogLevel::ALERT,
                'The message to log',
                AnsiConsole::FG_BLACK . AnsiConsole::BG_YELLOW . 'The message to log' . AnsiConsole::END,
            ],
            'Emergency log' => [
                LogLevel::EMERGENCY,
                'The message to log',
                AnsiConsole::FG_BLACK . AnsiConsole::BG_RED . 'The message to log' . AnsiConsole::END,
            ],
        ];
    }
}
